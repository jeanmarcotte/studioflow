 ...
 *
 * Sub-sections:
 * - Q3a: Couple name + service type badge
 * - Q3b: Wedding date countdown
 * - Q3c: Signed/Booked dates
 * - Q3d: 3-column grid (Contact/Venues/Package)
 * - Q3e: Status badges
 *
 * Guards:
 * - Null check on start_time/end_time (prevents NaN)
 */
...
export interface Q03ClientCardProps {
  couple: any;
  contract: any;
  extrasOrders: any[];
}

export function Q03ClientCard({ couple, contract, extrasOrders }: Q03ClientCardProps) {
