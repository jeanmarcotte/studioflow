...
export interface Q11FramesAndAlbumsProps {
  extrasOrder: any | null;
}

export function Q11FramesAndAlbums({ extrasOrder }: Q11FramesAndAlbumsProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 overflow-hidden mb-4">
      ...
      <div className="bg-gradient-to-r from-teal-600 to-teal-700 text-white px-5 py-4 flex justify-between items-center">
        <h3 className="font-semibold">Frames & Albums</h3>
