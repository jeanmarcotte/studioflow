...
export function LeadsHeader({ onMenuToggle }: LeadsHeaderProps) {
  return (
    <header className={`${nunito.className} sticky top-0 z-30 bg-white border-b border-border/60 px-4 py-3 md:px-6`}>
      <div className="flex items-center gap-3">
        ...
        {/* Logo */}
        <span className="text-base font-bold text-[#0d4f4f] tracking-tight shrink-0">SIGS BridalFlow</span>
        ...
        <div className="relative flex-1 max-w-xs hidden sm:block">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full h-9 rounded-lg border border-border bg-muted/30 pl-9 pr-3 text-sm outline-none focus:border-[#0d4f4f] focus:ring-1 focus:ring-[#0d4f4f]/20"
          />
        </div>
