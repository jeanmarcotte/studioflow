...
const SURNAME_PATTERNS: Record<string, string[]> = {
  ...
  'south asian': [
    'patel', 'sharma', 'singh', 'kumar', 'das', 'kaur', 'ali', 'khan',
    'ahmed', 'gupta', 'jain', 'shah', 'mehta', 'desai', 'nair', 'menon',
    'pillai', 'reddy', 'rao', 'iyer', 'iyengar', 'krishnan', 'mukherjee',
    'banerjee', 'chatterjee', 'bose', 'ghosh', 'sen', 'roy', 'dutta',
    'arul', 'rajan', 'subramaniam', 'venkatesh', 'srinivasan', 'ramesh',
  ],
  'irish': [
