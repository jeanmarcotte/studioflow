...
export async function POST(request: Request) {
  try {
    ...
    const formData = {
      ...
      groom_postal_code: body.groom_postal_code || null,
      ...
      bride_postal_code: body.bride_postal_code || null,
      ...
      ceremony_postal_code: body.ceremony_postal_code || null,
      ...
      park_postal_code: body.park_postal_code || null,
      ...
      extra_postal_code: body.extra_postal_code || null,
      ...
      reception_postal_code: body.reception_postal_code || null,
