...
export default function BallotPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('ballot_muted')
  ...
  const toggleMute = () => {
    ...
    setIsMuted(newValue)
    localStorage.setItem('ballot_muted', String(newValue))
  }
    ...
    {showSuccess ? (
      ...
      >
        <div className="text-center space-y-6">
          ...
          <Button
            onClick={handleReset}
            className="bg-white text-green-700 font-bold hover:bg-green-50"
          >
          ...
          <div className="max-w-lg mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {isMuted ? <VolumeX className="h-5 w-5 text-gray-400" /> : <Volume2 className="h-5 w-5 text-teal-600" />}
                </button>
