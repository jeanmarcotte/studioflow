...
| `on_hold` | Paused | — |
| `at_lab` | Sent to CCI/UAF/Best Canvas | m08 (engagement proofs), m12 (engagement non-proofs), m26 (wedding — NO TRIGGER) |
| `at_studio` | Received back from vendor | m09 + m13 (engagement — auto-paired), m29 (wedding — NO TRIGGER) |
